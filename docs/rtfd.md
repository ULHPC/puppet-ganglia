...
By default, the [puppet-ganglia](https://github.com/ULHPC/puppet-ganglia) repository is bound to the [ulhpc-puppet-ganglia](http://ulhpc-puppet-ganglia.rtfd.org) project on Read the Docs (to avoid confusion with other ganglia projects). 
